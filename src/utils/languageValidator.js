/**
 * Utility for validating whether entered text matches the selected language.
...
// Comprehensive Marathi Vocabulary
const MARATHI_WORDS = new Set([
  // Auxiliary verbs & conjugations
  ...
  // Question words & common verbs/adverbs
...
const HINDI_WORDS = new Set([
  ...
  // Question words, particles & adverbs
...
/**
 * Evaluates Hindi vs Marathi features in Devanagari text.
 */
...
/**
 * Validates text against the selected language.
